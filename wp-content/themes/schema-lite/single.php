			...
			<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
				<div id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
					<div class="single_post">
						...
						<?php if($schema_lite_single_breadcrumb_section == '1') { ?>
						...
						<header>
							...
							<!-- Start Post Meta -->
							<div class="post-info">
								<span class="theauthor"><i class="schema-lite-icon icon-user"></i> <?php _e('By','schema-lite'); ?> <?php the_author_posts_link(); ?></span>
						...
						<div id="content" class="post-single-content box mark-links">
							<?php the_content(); ?>
							<?php wp_link_pages(array('before' => '<div class="pagination">', 'after' => '</div>', 'link_before'  => '<span class="current"><span class="currenttext">', 'link_after' => '</span></span>', 'next_or_number' => 'next_and_number', 'nextpagelink' => __('Next', 'schema-lite' ), 'previouspagelink' => __('Previous', 'schema-lite' ), 'pagelink' => '%','echo' => 1 )); ?>
							<?php if($schema_lite_single_tags_section == '1') { ?>
								<!-- Start Tags -->
						...
						<?php if($schema_lite_relatedposts_section == '1') { ?>	
							<!-- Start Related Posts -->
						...
						<?php if($schema_lite_authorbox_section == '1') { ?>
							<!-- Start Author Box -->
							<div class="postauthor">
								<h4><?php _e('About Author', 'schema-lite'); ?></h4>
